<template>
          ...
          <el-table-column label="操作" width="120">
            <template #default="scope">
              <el-button
                ...
                type="primary"
                size="small"
                @click.prevent="removeTask(scope.$index, scope.row.id)"
              >
                删除
              </el-button>
              <el-button
                ...
                type="primary"
                size="small"
                @click.prevent="cancelTask(scope.$index, scope.row.id)"
              >
                取消
              </el-button>
              <el-button
                ...
                type="primary"
                size="small"
                @click.prevent="tailLog(scope.$index, scope.row.id)"
              >
                View Log
              </el-button>
            </template>
  ...
  <el-dialog v-model="dialogVisible" width="80%" title="LogViewer">
    <Suspense>
      <template #default>
