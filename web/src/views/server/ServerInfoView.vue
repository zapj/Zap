...
<table class="font-size-3 serverinfo"  >
    ...
    <tbody>
        ...
        <tr>
            <td>操作系统版本</td>
            <td>{{ state.serverInfo.OS }} / {{ state.serverInfo.Platform }}-{{ state.serverInfo.PlatformVersion }}</td>
            <td></td>
        </tr>
        <tr>
            <td>系统内核</td>
        ...
        <tr>
            <td>系统负载</td>
            <td><el-tag class="ml-2" type="success">{{ state.serverInfo.load1 }}</el-tag>  <el-tag class="ml-2" type="success">{{ state.serverInfo.load5 }}</el-tag>
        ...
        <tr>
            <td>已用内存</td>
            <td>{{ state.serverInfo.memory_used }}
        ...
        <tr>
            <td>已用内存</td>
            <td>{{ state.serverInfo.swapmem_used }}
